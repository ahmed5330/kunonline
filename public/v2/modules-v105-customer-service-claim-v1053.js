/* Kun Online v105.3 — live Customer Service contact ownership + sales/customer navigation. */
(function(){
  ...
  window.KunCustomerServiceClaimV105={version:'105.3',refresh,scan,arrangeSalesCustomerNavigation,stop:()=>{if(timer)clearInterval(timer);timer=null;}};
  document.documentElement.dataset.customerServiceClaim='v105.3-ready';
})();
