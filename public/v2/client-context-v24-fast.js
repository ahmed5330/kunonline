/* kun online v24 — central client/store context with page-lifetime resolved-context cache */
(function(){
  ...
  async function resolve(){if(cached)return cached;if(resolving)return resolving;resolving=resolveFresh().finally(()=>{resolving=null});return resolving;}
  ...
  window.KunClientContextV24={version:'24.0',clientId:resolve,storeId:window.kunStoreId,get cachedClientId(){return cached;}};
