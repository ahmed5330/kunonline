...
(function(){
  const HELP={
    ...
    'بدء الاستخدام':'قائمة خطوات تساعدك على تجهيز الحساب والمتجر والفريق والتكاملات قبل التشغيل.',
    'جاهزية النظام':'فحص مباشر للبيئة وقاعدة البيانات والجلسات والتشفير قبل الاعتماد النهائي.',
    'المتاجر والفروع':'إدارة أكثر من متجر أو فرع داخل نفس حساب Kun Online.',
    'صلاحيات الفروع':'تحديد أي عضو فريق يستطيع العمل على أي متجر أو فرع.',
    ...
    'مركز التكاملات':'يوضح المنصات التي يمكن ربطها، حالة الاتصال وما ينقص إعداد كل مزود بدون عرض أي Token أو Secret.',
    'الرصيد المستحق':'إجمالي فواتير المورد − المدفوعات − مرتجعات المشتريات المكتملة.',
    ...
    'Code Ready':'يعني أن الجداول الأساسية والجلسات وبيئة Preview جاهزة من داخل التطبيق.',
    'Integrations Ready':'يعني أن مفتاح تشفير بيانات التكاملات موجود ويمكن حفظ Credentials بشكل آمن.',
