...
console.log('Admin Client Command Center contract passed: all subscribed clients get compact period KPIs, searchable cards, fail-closed Admin routes and an Admin-only full brief with today/yesterday/7d/30d/MTD/custom ranges plus previous-period comparison.');
