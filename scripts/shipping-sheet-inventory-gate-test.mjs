...
for(const marker of ['Smart Shipping Sync','رقم الهاتف + الاسم + قيمة التحصيل','shipping-sheet-match','shipping-sheet-apply','inventoryAlreadySynced','inventoryAllocatedNow','كان مسمّع مسبقًا','خصم مخزون جديد','data-ss64-map="phone"','data-ss64-map="name"','data-ss64-map="codAmount"'])must(smartUi.includes(marker),`smart shipping UI marker missing: ${marker}`);
