...
must(/main\s*=\s*"src\/index-commerce-v19\.js"/.test(wrangler),'Preview must point at current commerce entry v19');
...
console.log(`Release readiness checks passed with ${migrations.length} migrations, v19 API entry and current v2 assets.`);
