...
must(/main\s*=\s*"src\/index-commerce-v20\.js"/.test(wrangler),'Preview must point at current commerce entry v20');
...
console.log(`Release readiness checks passed with ${migrations.length} migrations, v20 API entry and current v2 assets.`);
