...
must(/main\s*=\s*"src\/index-commerce-v12\.js"/.test(wrangler),'Preview must point at current commerce entry v12');
...
console.log(`Release readiness checks passed with ${migrations.length} migrations, v12 API entry and current v2 assets.`);
