...
must(/main\s*=\s*"src\/index-commerce-v18\.js"/.test(wrangler),'Preview must point at current commerce entry v18');
...
console.log(`Release readiness checks passed with ${migrations.length} migrations, v18 API entry and current v2 assets.`);
