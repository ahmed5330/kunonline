...
must(/main\s*=\s*"src\/index-commerce-v22\.js"/.test(wrangler),'Preview must point at current commerce entry v22');
...
for(const asset of ['modules-v10.js','modules-v11.js','modules-v12.js','modules-v13.js','modules-v14.js','modules-v15.js','modules-v16.js','modules-v17.js','modules-v18.js','modules-v19.js','modules-v20.js','kun-v8.css'])must(index.includes(asset),`Release UI asset missing: ${asset}`);
for(const view of ['dashboard','onboarding','stores','store-access','pos','orders','customers','inbox','inventory','procurement','supplier-finance','shipping','cod','campaigns','finance','profit','analytics','automation','ai','integrations','access','approvals','ops','audit','control','readiness','settings'])must(index.includes(`data-view="${view}"`),`Release navigation view missing: ${view}`);
...
console.log(`Release readiness checks passed with ${migrations.length} migrations, v22 API entry, real core actions and current v2 assets.`);
