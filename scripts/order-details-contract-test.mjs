...
for(const marker of ['تفاصيل المنتجات','بيانات العميل','بيانات وعنوان الشحن','ملخص الطلب','data-kod-cs-details','KunOrderDetails','button[data-order]','kod-options'])must(ui.includes(marker),`order details UI missing ${marker}`);
