...
must(index.includes('/v2/modules-v79-printing.js?v=79.6'),'J&T awaiting-print workflow asset must be cache-busted to v79.6');
...
must(printingUi.includes("version:'79.6'"),'J&T printing runtime must identify the carrier-authoritative v79.6 implementation');
...
console.log('Integration setup checks passed: governed connections, encrypted credential handoff, idempotent J&T setup, carrier-authoritative awaiting-print transition, official carrier label printing and guarded live tracking.');
