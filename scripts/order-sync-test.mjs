...
console.log('Commerce order sync contract passed: scoped webhook + persisted Short ID + resilient gap recovery + five-minute reconciliation + manual repair are wired.');