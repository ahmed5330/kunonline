...
try{
  ...
  const version=(await api('/api/preview/version')).data;if(version.build!=='preview-v31-2026-08-29-accounting'||version.entrypoint!=='index-commerce-v31.js')throw new Error(`Expected current accounting v31 Preview, got ${JSON.stringify(version)}`);
