...
try{
  ...
  const version=(await api(adminCookie,'/api/preview/version')).data;if(version.build!=='preview-v34-2026-08-30-meta-ads-expert'||version.entrypoint!=='index-commerce-v34.js')throw new Error(`Expected current v34 Preview, got ${JSON.stringify(version)}`);
