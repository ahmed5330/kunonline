...
try{
  ...
  const version=(await api(adminCookie,'/api/preview/version')).data;if(version.build!=='preview-v28-2026-08-28')throw new Error(`Expected v28, got ${JSON.stringify(version)}`);
