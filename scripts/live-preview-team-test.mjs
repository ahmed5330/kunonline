...
try{
  ...
  const version=(await api(adminCookie,'/api/preview/version')).data;if(version.build!=='preview-v29-2026-08-28')throw new Error(`Expected v29, got ${JSON.stringify(version)}`);
