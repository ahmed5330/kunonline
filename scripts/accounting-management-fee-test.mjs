...
console.log('Accounting + management fee contract passed: accountant workspace, admin-only per-store percentage, ship activation, return/cancel reversal, immutable historical rate, zero-rate-safe scheduled external-status reconciliation, live-QA syntax guard and dashboard/P&L decoration.');
