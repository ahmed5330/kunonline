...
for(const marker of ['function extractTracking','function delivered','function settled','jt_tracking_update','constantTimeEqual','/api/webhooks/jt/logistics/','/api/jt/webhook-url',"nextState='signed'","nextState='collected'","checkpoint='جاري التحصيل'"])assert.ok(worker.includes(marker),`J&T webhook worker missing ${marker}`);
