...
for(const marker of ['/api/jt/shipments/${encodeURIComponent(id)}/print','print79-sidebar-code','FOD','Cdos','REMARKS','FROM:','100×150'])assert.ok(printingUi.includes(marker),`J&T print UI missing ${marker}`);
