...
for(const marker of ['/api/jt/shipments/${encodeURIComponent(id)}/print','طباعة ونقل إلى تمت الطباعة','100×150'])assert.ok(printingUi.includes(marker),`J&T print UI missing ${marker}`);
