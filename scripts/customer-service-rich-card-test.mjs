...
for(const marker of ['/api/orders/','/details?clientId=','IntersectionObserver','data-cs-copy-value','navigator.clipboard','cs-rich-product','cs-rich-top','نسبة التسليم للعميل','نسخ اسم العميل','نسخ رقم الهاتف','نسخ البريد الإلكتروني','نسخ العنوان بالكامل','نسخ اسم المنتج','نسخ اللون/المقاس/الاختيارات','نسخ الكمية والسعر','item.options','item.lineTotal'])assert.ok(ui.includes(marker),`rich Customer Service card UI missing ${marker}`);
