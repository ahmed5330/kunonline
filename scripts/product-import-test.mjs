...
console.log('Commerce product import contract passed: explicit all/selected scope is mandatory, every targeted product requires a cost that also feeds variants, and Easy Orders discounted price is the authoritative selling price across supported field aliases.');