...
const expected = {worker:'kunonline-preview',entrypoint:'src/index-commerce-v12.js',database:'kunonline-preview',databaseId:'31cd5cdf-fc01-42d7-ba1e-571f3dd58495',binding:'DB'};
