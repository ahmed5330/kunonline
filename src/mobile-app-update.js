...
const RELEASE_APK='https://github.com/ahmed5330/kunonline/releases/download/android-latest/Kun-Online-Mobile-v2.6.0.apk';
const UPDATE={
  versionCode:110,
  versionName:'2.6.0',
  ...
  notes:[
    'إضافة زر إضافة أوردر مباشرة من تطبيق كن أونلاين.',
    'نموذج أوردر متوافق مع بيانات عنوان J&T: المحافظة ثم المدينة/الحي ثم المنطقة ثم الشارع.',
    'اعتماد دليل J&T Egypt الرسمي المحفوظ بالنظام مع أكواد المحافظة والمدينة والمنطقة بدون تخمين.',
    'إضافة بيانات المستلم والمنتج والكمية وقيمة التحصيل والوزن والملاحظات من داخل التطبيق.',
    'مزامنة الأوردر الجديد فور حفظه مع بيانات العملاء والمكالمات وCaller ID.'
  ]
};
...
async function directApkDownload(request){
  try{
    ...
    headers.set('Content-Disposition','attachment; filename="Kun-Online-Mobile-v2.6.0.apk"');
