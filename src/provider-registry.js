export const PROVIDERS=[
  ...
  {id:'meta_ads',category:'marketing',name:'Meta Ads',requiredSecrets:['access_token'],capabilities:['campaigns.read','metrics.read']},
  {id:'google_ads',category:'marketing',name:'Google Ads',requiredSecrets:['developer_token','refresh_token','client_id','client_secret'],capabilities:['campaigns.read','metrics.read']},
  {id:'tiktok_ads',category:'marketing',name:'TikTok Ads',requiredSecrets:['access_token'],capabilities:['campaigns.read','metrics.read']},
...
export function publicProvider(p){return {id:p.id,category:p.category,name:p.name,capabilities:[...p.capabilities],requiredSecrets:[...p.requiredSecrets]};}
