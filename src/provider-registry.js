export const PROVIDERS=[
  ...
  {id:'jt',category:'shipping',name:'J&T Express',requiredSecrets:['api_account','private_key','source_code'],capabilities:['shipments.create','tracking.read','webhooks'],activationNote:'J&T Express Egypt: إنشاء الشحنات وحفظ AWB واستقبال Logistics trajectory feedback. Developer Info الأساسي: API Account + Private Key + Source Code؛ بيانات Enterprise Info اختيارية إذا طلبها حساب Create Order.'},
