export const PROVIDERS=[
  ...
  {id:'jt',category:'shipping',name:'J&T Express',requiredSecrets:['api_account','private_key','source_code'],capabilities:['shipments.create','tracking.read','webhooks'],activationNote:'J&T Express Egypt: Developer Info الأساسي هو API Account + Private Key + Source Code. التتبع والتهيئة يعتمدان عليه؛ إنشاء البوليصة Create Order يحتاج بالإضافة إليه Business Info: Customer Code / Merchant Code + Customer Password / API Password، مع بيانات الراسل.'},
